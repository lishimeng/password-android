...
import com.thingple.keyboard.password.adapter.KeyBoardAdapter;
...
public class PasswordView extends RelativeLayout {
    ...
    //设置监听方法，在第6位输入完成后触发
    public void setPasswordInputListener(final PasswordInputListener passwordInputListener) {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.toString().length() == 1) {
                    ...
                    if (passwordInputListener != null) {
                        passwordInputListener.onInputFinish(strPassword);    //接口中要实现的方法，完成密码输入完成后的响应逻辑
                    }
                }
            }
        });
